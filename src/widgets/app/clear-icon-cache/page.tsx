...
export default function ClearIconCacheWidget() {
  const theme = useTheme();
  const { getToolOutput } = useWidgetSDK();
  const data = getToolOutput<D>();
  return <ActionCard icon="🖼️" title="Clear Icon Cache" subtitle="Fix blank/wrong desktop icons" gradient="linear-gradient(135deg,#8b5cf6,#7c3aed)" data={data} theme={theme} />;
}
