...
export default function DisableStartupAppWidget() {
  const theme = useTheme();
  const { getToolOutput } = useWidgetSDK();
  const data = getToolOutput<D>();
  return <ActionCard icon="🚫" title="Disable Startup App" subtitle="Stop app from auto-launching" gradient="linear-gradient(135deg,#f59e0b,#ef4444)" data={data} theme={theme} />;
}
