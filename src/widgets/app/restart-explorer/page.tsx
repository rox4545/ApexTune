...
export default function RestartExplorerWidget() {
  const theme = useTheme();
  const { getToolOutput } = useWidgetSDK();
  const data = getToolOutput<D>();
  return <ActionCard icon="🗂️" title="Restart Explorer" subtitle="Fixes taskbar & Start menu" gradient="linear-gradient(135deg,#f59e0b,#d97706)" data={data} theme={theme} />;
}
