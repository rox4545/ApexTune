...
export default function TurboBoostWidget() {
  const theme = useTheme();
  const { getToolOutput } = useWidgetSDK();
  const data = getToolOutput<D>();
  return <ActionCard icon="🚀" title="Turbo Boost" subtitle="High-performance power mode" gradient="linear-gradient(135deg,#f59e0b,#ef4444)" data={data} theme={theme} />;
}
