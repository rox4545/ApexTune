...
export default function CleanTempFilesWidget() {
  const theme = useTheme();
  const { getToolOutput } = useWidgetSDK();
  const data = getToolOutput<D>();
  return <ActionCard icon="🗑️" title="Clean Temp Files" subtitle="Free up disk space" gradient="linear-gradient(135deg,#10b981,#059669)" data={data} theme={theme} />;
}
